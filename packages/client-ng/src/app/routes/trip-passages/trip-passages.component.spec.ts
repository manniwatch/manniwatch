...
describe('src/app/routes/trip-passages/trip-passage.component', (): void => {
    describe('TripPassagesComponent', (): void => {
        const testStatusSubject = new Subject<IPassageStatus>();
        const testVehicleLocationSubject = new Subject<IVehicleLocation>();
        ...
        describe('with status set', (): void => {
            ...
            beforeEach((): void => {
                ...
                cmpFixture.detectChanges();
                listDebugElement = cmpFixture.debugElement.query(By.directive(TestTripPassagesListComponent));
                mapHeaderDebugElement = cmpFixture.debugElement.query(By.directive(TestStaticMapDirective));
                notFoundDebugElement = cmpFixture.debugElement.query(By.css('div.not-found'));
            });
