...
import { IActualTripPassage, IDepartedTripPassage, ITripPassage, ITripPassages, VEHICLE_STATUS } from '@manniwatch/api-types';
        ...
        describe('properties', (): void => {
            ...
            describe('set - tripInfo', (): void => {
                ...
                it('should set passages ordered correctly with only old provided', (): void => {
                    ...
                    expect(cmp.passages).toEqual([testOldPassages[1], testOldPassages[2], testOldPassages[0]]);
                });
                it('should set passages ordered correctly with only actual provided', (): void => {
                    ...
                    expect(cmp.passages).toEqual([testActualPassages[1], testActualPassages[2], testActualPassages[0]]);
                });
            });
        });
                ...
                [1, 2, 3].forEach((testNum: number): void => {
                    it(`should display ${testNum} all relavent items`, (): void => {
                        ...
                        listItems = cmpFixture.debugElement
                            ...
                            .map(
                                (val: DebugElement): TestTripPassagesListItemComponent =>
                        ...
                        const mappedValues: ITripPassage[] = listItems.map(
                            (itemCmp: TestTripPassagesListItemComponent): ITripPassage => itemCmp.passage
                        );
