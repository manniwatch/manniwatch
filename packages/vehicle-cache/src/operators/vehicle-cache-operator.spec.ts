        ...
        describe('test cold observable', function (): void {
            ...
            it('should not emit previously already deleted locations', function (): void {
                testScheduler.run((helpers: RunHelpers): void => {
                    ...
                    expectObservable(foreverStream$, unsub).toBe('16ms a------|', {
                        a: sourceValues.g,
                    });
                });
            });
            ...
            it('should emit new if previously deleted', function (): void {
                testScheduler.run((helpers: RunHelpers): void => {
                    ...
                    expectObservable(foreverStream$, unsub).toBe('16ms a--b|', {
                        a: sourceValues.g,
                        b: sourceValues.j,
                    });
                });
        ...
        describe('test hot observable', function (): void {
            ...
            it('should not emit previously already deleted locations', function (): void {
                testScheduler.run((helpers: RunHelpers): void => {
                    ...
                    expectObservable(foreverStream$, unsub).toBe('8ms a|', {
                        a: sourceValues.i,
                    });
                });
            });
            ...
            it('should emit new if previously deleted', function (): void {
                testScheduler.run((helpers: RunHelpers): void => {
                    ...
                    expectObservable(foreverStream$, unsub).toBe('10ms a--b|', {
                        a: sourceValues.g,
                        b: sourceValues.j,
                    });
                });
